...
## Research
Understanding how the brain sense and decide how to navigate in environment is a fundamental goal of neuroscience. Of the senses, touch may be the most vital. The sense of touch is generated by a diverse array of sensory neurons, and i am interested in understanding how they are used in the downstream brain circuitry. By combing precise tactile stimuli and behavioral tracking with modern neurophysiological recording methods (including calcium imaging and multielectrode array electrophysiology), as well as computational and engineering tools, I believe we can gain insights into circuit-level principles: <b><em> How do neuron in central somatosensory system respond across variety of contexts in health and disease?</em></b>  To that end, my research has spanned three main directions:

1. <b>Mechanistic</b>: Many studies demonstrate neuron in S1 are tuned to tactile motion, but does it merely encode this information, or is it actually required for animals to perceive it? 
...
2. <b>Descriptive</b>: First to characterize compromised dopaminergic projection, single-neuron and population activity in Primary Somatosensory Cortex (S1) of Parkinson mice with electrophysiological experiment, computational and anatomical analysis.
